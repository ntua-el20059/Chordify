...
def main():
    ...
    for i in range(5):
        ...
        commands = [
            ...
            f"python3 run_experiments.py --node_number {node1} --consistency linearizability --replication 1 --signal_port {signal_port1}",
            f"python3 run_experiments.py --node_number {node2} --consistency linearizability --replication 1 --signal_port {signal_port2}"
        ]
